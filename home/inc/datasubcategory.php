...
if(isset($_POST['id'])){
    ...
    $sql = "SELECT
        ...
        t.parent_id,t.id
       FROM upload_file_category t
       LEFT JOIN upload_file_category_path p ON t.id = p.id
       WHERE t.parent_id = '$id' AND t.category_active=1
       ORDER BY p.path ASC";

    $result = db_select($sql);
    echo '<select name="file_subcategory" id="file_subcategory" class="form-control input-sm m-bot15">';
