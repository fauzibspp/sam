            ...
            <div class="col-lg-12">
                ...
                <section class="panel">
                    <div class="inbox-head">
                        <h3><i class="icon-reply"></i> Reply</h3>
                    </div>
                        ...
                        <form id="composeform" action="process_message.php" name="composeform" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email_subject" id="email_subject" class="form-control" placeholder="Subjek" value="RE: <?php echo $subject ?>" />
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control error" cols="60" rows="5" id="email_message" name="email_message" placeholder="Mesej">
                                        <p></p>

                                        <div style="border-left:1px #ccc solid;margin-left:1em;padding-left:2ex ">

                                                <?php echo $date ?>, <?php echo $from ?> menulis: <br>
