...
*	Version: 1.3
*   allowedExtension: 'jpg|jpeg|gif|png|doc|docx|pdf',
*/
...
(function($) {
	...
	$.fn.fileUploader = function(config){
		...
		config = $.extend({}, {
			...
			selectFileLabel: 'Tarik Fail & Letak Disini',
			allowedExtension: 'pdf|jpg|jpeg|png',
