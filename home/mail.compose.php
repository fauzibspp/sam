            ...
            <form name="form_receipient" id="form_receipient" class="form-horizontal" role="form">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button id="tutup" class="btn btn-primary" data-dismiss="modal" aria-hidden="true">Tutup</button>
            ...
            <div class="col-lg-12">
                ...
                <section class="panel">
                    <div class="inbox-head">
                        <h3><i class="icon-edit-sign"></i> Compose</h3>
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="input-group-btn">
                            <button style="float: right" type="button" id="startUpload" class="finish btn btn-success form-inline"><i class="icon-envelope-alt"></i> Hantar</button>
                        </div>
                        ...
                        <form id="composeform" action="process_message.php" name="composeform" enctype="multipart/form-data">
                            ...
                            ?>
                            <input type="hidden" name="cmd" id="cmd" value="Compose"/>
                            <div class="modal-body">
                                <div class="form-group">
                                    <input type="text" name="email_to" id="email_to" value="" class="form-control" placeholder="Kepada" />
                                </div>
                                <div class="form-group">
                                    <input type="text" name="email_subject" id="email_subject" value="" class="form-control" placeholder="Subjek" />
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control error" cols="60" rows="5" id="email_message" name="email_message" placeholder="Mesej"></textarea>
                                </div>
                                <div class="form-group">
