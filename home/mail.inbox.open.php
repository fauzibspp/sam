    ...
    <section class="wrapper site-min-height">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                //echo $url;
                parse_str($url);
                //$message = fnGetRecord1Param('messageid','textbody','email_inbox',$id);
                //$message = fnSQLCustom("select textbody from email_inbox where messageid='$id'","textbody");
                $sql = "select textbody from email_inbox where messageid='$id'";
                $rst = db_select($sql);
                    ...
                    <div class="panel-body">
                        <div class="input-group-btn">
                                ...
                                <div class="btn-group hidden-phone">
                                    ...
                                    <ul class="dropdown-menu">
                                        <?php foreach($rows_attach as $row_attach):
                                            ...
                                            ?>
                                        <li>
                                            <a class="<?php echo $class ?>" href="../attachments/<?php echo $v_owner ?>/inbox/<?php echo $id ?>/<?php echo $row_attach['filename'] ?>" >
                            ...
                            <div class="btn-group-sm">
                                <a href="mail.inbox.forward.php?url=<?php echo base64_encode($mail_response) ?>" id="startForward" class="finish btn btn-primary btn-sm form-inline"><i class="icon-forward"></i> Forward</a>
                        ...
                        <div id="loading"></div>
                        <!-- content message -->
                        <span class="text-primary">Isi kandungan<?php echo $message ?></span>
                        <!-- content message -->
                    </div>
                </section>
