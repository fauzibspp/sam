                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            <i class="icon-file"></i> Senarai Pangkat
                        </header>
                        <!--widget start-->
        ...
        $('.simpan').click(function(){
            ...
            if($('#Desc').val()==''){
                ...
                $.ajax({
                    type: 'post',
                    url: 'process.php',
                    data: datastring + '&token='+$('#token').val()+'&tbl=c45_pangkat',
        ...
        if(y = confirm('Anda pasti untuk teruskan?')){
            if(y){
                $.ajax({
                    type: 'post',
                    url: 'process.php',
                    data: datastring + '&token='+$('#token').val()+'&cmd=DelDataDictionary&tbl=c45_pangkat',
                    success: function(html)
                    {
                        alert(html);
                        location.reload();
