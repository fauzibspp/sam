                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            <i class="icon-file"></i> Senarai Kementerian/Unit/Pasukan
                        </header>
                        <!--widget start-->
        ...
        $('.simpan').click(function(){
            ...
            if($('#Desc').val()==''){
                ...
                $.ajax({
                    type: 'post',
                    url: 'process.php',
                    data: datastring + '&token='+$('#token').val()+'&tbl=c76_unit',
        ...
        if(y = confirm('Anda pasti untuk teruskan?')){
            if(y){
                $.ajax({
                    type: 'post',
                    url: 'process.php',
                    data: datastring + '&token='+$('#token').val()+'&cmd=DelDataDictionary&tbl=c76_unit',
                    success: function(html)
                    {
                        alert(html);
                        location.reload();
